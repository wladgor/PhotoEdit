...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label_2.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:14pt;\">В 2 графе - файл который был изменём</span></p><p><span style=\" font-size:14pt;\">В 3 графе - переменная в которую он был сохранён</span></p></body></html>"))
        self.dela.setText(_translate("Form", "Удалить выбранный элемент"))
        self.redac.setText(_translate("Form", "Изменить выбранный элемент"))
        self.linetxt.setText(_translate("Form", "Введите новое название эллементу:"))
